...
export default function PreExamVerification() {
  ...
  const examIdFromState = (location.state as { selectedExamId?: string })?.selectedExamId;
  ...
  useEffect(() => {
    if (examIdFromState) {
      localStorage.setItem("selectedExamId", examIdFromState);
    }
  }, [examIdFromState]);
  ...
  const handleStartExam = () => {
    navigate("/exam", {
      state: {
        selectedExamId: examIdFromState ?? localStorage.getItem("selectedExamId"),
      },
    });
  };
