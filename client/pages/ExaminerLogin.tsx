...
import { Mail, Lock, ArrowLeft, ClipboardList, Eye, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-pink-50 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="max-w-md w-full">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Examiner Login</h1>
          <p className="text-gray-600">Sign in to manage your exams</p>
        </div>
